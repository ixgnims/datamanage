    ...
    <el-card shadow="hover" style="margin-top: 5px">
      <el-tabs v-model="activeTab" @tab-click="handleTabClick">
        <el-tab-pane label="单量ROI" name="Order">
          <Shuangyu49_orderChart2 :activeTab="activeTab" :selectLive="selectLive"
                                  :last_order_cnt="last_order_cnt" :roiInput="roiInput"
                                  :order_goal="order_goal"/>
        </el-tab-pane>
        <el-tab-pane label="投流视频" name="Video">
          <Shuangyu49_materialChart2 :activeTab="activeTab" :tag_type="tag_type" :selectLive="selectLive"
...
<script>
import Shuangyu49_orderChart2 from "@/views/dashboard/Shuangyu49/Shuangyu49_orderChart2.vue";
import Shuangyu49_materialChart2 from "@/views/dashboard/Shuangyu49/Shuangyu49_materialChart2.vue";

export default {
  name: "Shuangyu49_chartTab",
  components: {
    Shuangyu49_materialChart2,
