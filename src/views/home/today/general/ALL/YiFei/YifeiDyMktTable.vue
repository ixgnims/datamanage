...
export default {
  ...
  data () {
    return {
      ...
      footerData: [
        {
          account_name: '合计', cost_diff: '0', click_diff: '0', stat_cost: '0',
          pay_order_amount: '0', indirect_order_pay_gmv_7days: '0',
  ...
  methods: {
    async getData() {
      try {
        // 尝试API直连
        const response = await axios.get(`/marketing/today/table/yifei`);
