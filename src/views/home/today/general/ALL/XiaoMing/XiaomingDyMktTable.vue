  ...
  <div>
    ...
    <el-row>
      ...
      <vxe-table
        ...
        <vxe-column
            field="XiaoMing_indirect_order_amount_7days_thisMonth"
            title="7日支付"
            :formatter="rounding"
            sort-type="number"
            sortable>
...
export default {
      ...
      footerData: [
        {
          ...
          pay_order_amount: '0', indirect_order_pay_gmv_7days: '0', XiaoMing_indirect_order_amount_7days_thisMonth: '0',
  ...
  methods: {
    async getData() {
      try {
        // 尝试API直连
        const response = await axios.get(`/marketing/today/table/xiaoming/`);
        ...
        var XiaoMing_indirect_order_amount_7days_thisMonth = response.data.map(item => item.XiaoMing_indirect_order_amount_7days_thisMonth).reduce((a, b) => a + b);
        XiaoMing_indirect_order_amount_7days_thisMonth = parseFloat(XiaoMing_indirect_order_amount_7days_thisMonth.toFixed(2));
        if (stat_cost_sum > 0) {
        ...
        this.footerData = [{
          ...
          XiaoMing_indirect_order_amount_7days_thisMonth: XiaoMing_indirect_order_amount_7days_thisMonth,
