<template>
  <div>
    ...
    <!--直播数据看板-->
    <AliuLiveDash :parentLiveDate = "live_date" class="dataBox"/>
    <AliuDyMktDetail :parentLiveDate="live_date" class="dataBox"/>
  </div>
</template>

<script>
import AliuLiveDash from "./AliuLiveDash.vue"
import AliuDyMktDetail from "./AliuDyMktDetail.vue"
export default {
  name: "ALiuLiveAnalysis",
  data() {
    return {
      pickerOptions: {
        disabledDate(date) {
