  ...
  data() {
    ...
    return {
      ...
      statCardsDay: [
        ...
        {label: "7日单量", metric: "deal_order_num_7d", suffix: ""},
        {label: "7日GMV", metric: "deal_order_gmv_7d", suffix: ""},
        {label: "7日ROI", metric: "deal_order_roi_7d", suffix: ""},
